            ...
            <div className="container">
                ...
                <div className="project-card mx-auto mb-4">
                    <div className="card-body">
                        ...
                        <p className="project-tech">Angular | Node.js | MSSQL | TypeScript</p>
                ...
                <div className="project-card mx-auto mb-4">
                    <div className="card-body">
                        ...
                        <p className="project-tech">C | System Programming</p>
                ...
                <div className="project-card mx-auto mb-4">
                    <div className="card-body">
                        ...
                        <p className="project-tech">Android | Kotlin | Game Dev</p>
